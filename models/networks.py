...
class JointLoss(nn.Module):
    ...
    def __call__(self, input_images, log_pred_d_0, pred_confidence, targets):
        ...
        d_gt_0 = autograd.Variable(targets['depth_gt'], requires_grad=False)
        ...
        gt_mask = autograd.Variable(targets['gt_mask'], requires_grad=False)
        human_mask = 1.0 - \
            autograd.Variable(targets['env_mask'], requires_grad=False)
